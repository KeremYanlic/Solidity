...
contract DSCEngine is ReentrancyGuard {
    ...
    // If someone is almost undercollateralized, we will pay you yo liquidate them !
    // $75 backing $50 DSC
   ...
   /**
     ...
     * @notice This function working assumes the protocol will be roughly 200% overcollateralized in order to for this to work.
